...
/*整个页面的内容  都是复制过来的  如果有需要改的地方 你就大胆的修改吧~~~~~~~   2017-06-09*/


// $("input:text,select").wrap("<div class='input-group'></div>")
//     .after("<span class='input-group-addon'><i class='fa fa-lg fa-lightbulb-o'></i></span>");
//自动翻译方法
                ...
                if (result.code === "EXCEPTION") {
                    ...
                    $.layer.msg("操作成功", {}, function () {
                        ...
                        $.layer.open({
                            ...
                            area: ['700px', '600px'],
                            content: '/m/upload.html?cid=' + result.id + "&range=USA"
                        });
                    });
                }
            }
