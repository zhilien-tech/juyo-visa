...
public enum OrderVisaApproStatusEnum implements IEnum {
	placeOrder(15, "下单"), shared(1, "已分享"), writeInfo(2, "资料填写"), firstReview(3, "初审"), agree(4, "通过"), refuse(5, "拒绝"), waitingSend(
			...
			10, "约签"), Return(11, "返回"), refuseVisa(12, "拒签"), complete(13, "完成"), EVUS(14, "EVUS"), japansend(17, "递送"), japancoming(
			18, "发招宝中"), japanAlreadySend(19, "已发招宝"), japanSendFail(20, "发招宝失败"), japanReport(21, "归国报告"), japanReportFail(
			22, "归国报告失败");
	private int key;
