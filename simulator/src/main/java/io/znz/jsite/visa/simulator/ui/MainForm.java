...
public class MainForm extends JPanel {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (String file : files) {
                    ...
                    //如果是 pdf 则重命名为任务 ID
                    if (fileName.toLowerCase().endsWith(".pdf")) fileName = tid + ".pdf";
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            panel1.add(pyFile, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));
            ...
            panel1.add(pyPicker, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
            ...
            panel1.add(host, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));
            ...
            panel1.add(port, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));
            ...
            panel1.add(executeTask, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 0), 0, 0));
            ...
            panel1.add(command, new GridBagConstraints(1, 3, 2, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        ...
        //======== panel3 ========
        {
            ...
            resultFiles.setToolTipText("DS-160\u5728\u7ebf\u7b7e\u8bc1\u7533\u8bf7\u5f97\u5230\u7684 pdf \u548c bat \u6587\u4ef6");
            panel3.add(resultFiles, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));
            ...
            panel3.add(filesPicker, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 0), 0, 0));
            ...
            panel3.add(taskId, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 0, 5), 0, 0));
            ...
            panel3.add(upload, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 0, 0), 0, 0));
        }
        ...
        //======== popupMenu ========
        {
            ...
            //---- all ----
            all.setText("\u5168\u9009");
            all.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
